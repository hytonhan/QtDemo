...
public:
    ...
    virtual std::vector<AssociationItem> fetchAvailable(int programId) = 0;
    virtual std::vector<AssociationItem> fetchAssigned(int programId) = 0;

    virtual std::vector<Program> fetchPrograms(int entityId) = 0;
